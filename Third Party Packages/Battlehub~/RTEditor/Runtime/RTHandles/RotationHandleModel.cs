    ...
    public class RotationHandleModel : BaseHandleModel
    {
        ...
        protected override void Awake()
        {
            ...
            if (m_useColliders)
            {
                ...
                colliders.layer = 10;//Editor.CameraLayerSettings.RuntimeGraphicsLayer + Window.Index;
                colliders.tag = "Handles";
                ...
                foreach(Collider collider in m_colliders)
                {
                    ...
                    collider.gameObject.layer = 10;// Editor.CameraLayerSettings.RuntimeGraphicsLayer + Window.Index;
                }
            }
        }
