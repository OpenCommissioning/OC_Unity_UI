...
namespace Battlehub.RTHandles
{
    ...
    public class RuntimeSelectionComponent : RTEComponent, IRuntimeSelectionComponent
    {
        ...
        {
            get => _hoverLayerMask.value;
        }

        [SerializeField]
        private LayerMask _hoverLayerMask;
        [SerializeField]
        ...
        public static RuntimeSelectionComponent Instance;
...
//
        ...
        private void SelectGO<T>(bool multiselect, bool allowUnselect, IList<T> hits, Func<T, GameObject> getGameObject)
        {
            if (hits.Count > 0)
            {
                ...
                //Modified
                //if (Selection.activeGameObject == hitGO)
                //{
                //    //Debug.Log("Already selected, next one");

                //    hitGO = GetNextGo(hits, getGameObject);
                //    //TryToClearSelection();
                //    //return;
                //}
        ...
        public void CustomSelectMultipleGO(GameObject hitGO) 
        {
            SelectGO(true, true, hitGO);
        }
        public void CustomSelectSingleGO(GameObject hitGO)
        {
            SelectGO(false, false, hitGO);
        }


        public void CustomDeselectAll()
        {
            //Adding null to selection clears selection
            SelectGO(false, false, null);
        ...
        private void OnRuntimeToolChanged()
        {
            ...
            //if (hasSelection && Editor.Tools.Current == RuntimeTool.View)
            //{
            //    TryToClearSelection();
            //} 
